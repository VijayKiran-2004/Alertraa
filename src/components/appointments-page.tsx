...
export default function AppointmentsPage({ onBookVisit, isDarkMode }: AppointmentsPageProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <SectionCard title="Upcoming Appointments" isDarkMode={isDarkMode}>
        {mockData.appointments.upcomingBookings.length > 0 ? (
          ...
          <p className={`text-sm ${secondaryTextClasses}`}>You have no upcoming appointments.</p>
        )}
      </SectionCard>
